            ...
            <div className='text-[14px] prose prose-slate dark:prose-invert max-w-none'>
                <ReactMarkdown
                    ...
                    components={{
                        ...
                        th({ children }) {
                            return <th className="px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{children}</th>;
                        },
                        td({ children }) {
                        ...
                        img({ src, alt }) {
                            return <img src={src} alt={alt} className="my-4 mx-w-full rounded" />;
                        },
                    }}
                >
                    {content}
...
function CodeBlock({code,language}){
    ...
    return <div className='realtive my-6 rounded-lg overflow-hidden bg-gray-50 border-gray-200'>
