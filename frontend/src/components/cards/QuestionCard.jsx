...
import { LuSparkles,LuPin,LuPinOff,LuChevronDown } from 'react-icons/lu'
import AIResponsePreview from '../../page/InterviewPrep/components/AIResponsePreview';
        ...
        <div className='bg-white rounded-lg mb-4 overflow-hidden py-4 px-5 shadow-xl shadow-gray-100/70 border border-gray-100/60 group'>
            <div className='flex items-center justify-between cursor-pointer'>
                ...
                <div className='flex items-center justify-end ml-4 relative'>
                    <div className={`flex ${isExpanded ? "md:flex":"md:hiddin group-hover:flex"}`}>
